...
public interface Cooking
{
	...
	enum Cookable
	{
		...
		SWORDTIP_SQUID(ItemID.RAW_SWORDTIP_SQUID, ItemID.SWORDTIP_SQUID),
		GIANT_KRILL(ItemID.RAW_GIANT_KRILL, ItemID.GIANT_KRILL),
		HADDOCK(ItemID.RAW_HADDOCK, ItemID.HADDOCK),
		YELLOWFIN(ItemID.RAW_YELLOWFIN, ItemID.YELLOWFIN),
		HALIBUT(ItemID.RAW_HALIBUT, ItemID.HALIBUT),
		BLUEFIN(ItemID.RAW_BLUEFIN, ItemID.BLUEFIN),
		MARLIN(ItemID.RAW_MARLIN, ItemID.MARLIN);
	...
	enum CamdozaalFish
	{
		...
		RAW_CATFISH(ItemID.RAW_CATFISH);
