...
public class ChatboxDetector extends ActionDetector
{
	...
	private static final Product[] MULTI_MATERIAL_PRODUCTS = {
            ...
            new Product(FLETCH_CUT_BOW, LONGBOW_U, new Ingredient[]{new Ingredient(LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, OAK_LONGBOW_U, new Ingredient[]{new Ingredient(OAK_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, WILLOW_LONGBOW_U, new Ingredient[]{new Ingredient(WILLOW_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, MAPLE_LONGBOW_U, new Ingredient[]{new Ingredient(MAPLE_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, YEW_LONGBOW_U, new Ingredient[]{new Ingredient(YEW_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, MAGIC_LONGBOW_U, new Ingredient[]{new Ingredient(MAGIC_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, SHORTBOW_U, new Ingredient[]{new Ingredient(LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, OAK_SHORTBOW_U, new Ingredient[]{new Ingredient(OAK_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, WILLOW_SHORTBOW_U, new Ingredient[]{new Ingredient(WILLOW_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, MAPLE_SHORTBOW_U, new Ingredient[]{new Ingredient(MAPLE_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, YEW_SHORTBOW_U, new Ingredient[]{new Ingredient(YEW_LOGS)}, new Ingredient(KNIFE)),
            new Product(FLETCH_CUT_BOW, MAGIC_SHORTBOW_U, new Ingredient[]{new Ingredient(MAGIC_LOGS)}, new Ingredient(KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, LONGBOW_U, new Ingredient[]{new Ingredient(LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, OAK_LONGBOW_U, new Ingredient[]{new Ingredient(OAK_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, WILLOW_LONGBOW_U, new Ingredient[]{new Ingredient(WILLOW_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, MAPLE_LONGBOW_U, new Ingredient[]{new Ingredient(MAPLE_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, YEW_LONGBOW_U, new Ingredient[]{new Ingredient(YEW_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, MAGIC_LONGBOW_U, new Ingredient[]{new Ingredient(MAGIC_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, SHORTBOW_U, new Ingredient[]{new Ingredient(LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, OAK_SHORTBOW_U, new Ingredient[]{new Ingredient(OAK_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, WILLOW_SHORTBOW_U, new Ingredient[]{new Ingredient(WILLOW_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, MAPLE_SHORTBOW_U, new Ingredient[]{new Ingredient(MAPLE_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, YEW_SHORTBOW_U, new Ingredient[]{new Ingredient(YEW_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
			new Product(FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE, MAGIC_SHORTBOW_U, new Ingredient[]{new Ingredient(MAGIC_LOGS)}, new Ingredient(FLETCHING_KNIFE)),
