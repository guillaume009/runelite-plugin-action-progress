...
public class ChatboxDetector extends ActionDetector
{
	...
	private static final Product[] MULTI_MATERIAL_PRODUCTS = {
			...
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(OAK_LONGBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, OAK_LONGBOW, new Ingredient(OAK_LONGBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(WILLOW_LONGBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, WILLOW_LONGBOW, new Ingredient(WILLOW_LONGBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(MAPLE_LONGBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, MAPLE_LONGBOW, new Ingredient(MAPLE_LONGBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(YEW_LONGBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, YEW_LONGBOW, new Ingredient(YEW_LONGBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(MAGIC_LONGBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, MAGIC_LONGBOW, new Ingredient(MAGIC_LONGBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(SHORTBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, SHORTBOW, new Ingredient(SHORTBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(OAK_SHORTBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, OAK_SHORTBOW, new Ingredient(OAK_SHORTBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(WILLOW_SHORTBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, WILLOW_SHORTBOW, new Ingredient(WILLOW_SHORTBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(MAPLE_SHORTBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, MAPLE_SHORTBOW, new Ingredient(MAPLE_SHORTBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(YEW_SHORTBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
            new Product(FLETCH_STRING_BOW, YEW_SHORTBOW, new Ingredient(YEW_SHORTBOW_U), new Ingredient(BOW_STRING)),
			new Product(FLETCH_STRING_BOW, LONGBOW, new Ingredient[]{new Ingredient(MAGIC_SHORTBOW_U)}, new Ingredient(BOW_STRING_SPOOL)),
