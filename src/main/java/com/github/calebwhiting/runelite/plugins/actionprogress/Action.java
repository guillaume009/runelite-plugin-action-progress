...
public enum Action
{
	...
	FLETCH_CUT_ARROW_SHAFT_FLETCHING_KNIFE("Cutting", ActionProgressConfig::fletchArrowsAndBolts, ActionIcon.SPRITE_FLETCHING, 2),
	FLETCH_CUT_BOW("Cutting", ActionProgressConfig::fletchBows, ActionIcon.SPRITE_FLETCHING, 3),
	FLETCH_CUT_BOW_WITH_FLETCHING_KNIFE("Cutting", ActionProgressConfig::fletchBows, ActionIcon.SPRITE_FLETCHING, 2),
