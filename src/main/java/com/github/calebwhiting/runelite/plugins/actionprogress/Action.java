...
public enum Action
{
	...
	FLETCH_SEER_SPINNING("Spinning", ActionProgressConfig::fletchSpinning, ActionIcon.SPRITE_FLETCHING, 2),
	...
	BUTTERFLY_MIX("Mixing",ActionProgressConfig::grinding, ActionIcon.SPRITE_TOTAL, 3),
	...
	MAGIC_BAKE_PIE("Baking pie", ActionProgressConfig::magicBakePie, ActionIcon.SPRITE_MAGIC, 3),
	...
	SMITHING_WITH_SMITH_OUTFIT("Forging", ActionProgressConfig::smithSmithing, ActionIcon.SPRITE_SMITHING, 4),
	...
	FARM_PLANT_TREE_SEEDS("Planting", ActionProgressConfig::plantTreeSeed, ActionIcon.SPRITE_FARMING, 0, 3),
	...
	CHURNING_CREAM_WITH_BOTTOMLESS_MILK("Churning", ActionProgressConfig::cookingChurning, ActionIcon.SPRITE_COOKING,10),
	...
	CHURNING_BUTTER_WITH_BOTTOMLESS_MILK("Churning", ActionProgressConfig::cookingChurning, ActionIcon.SPRITE_COOKING,19),
	...
	CHURNING_CHEESE_WITH_BOTTOMLESS_MILK("Churning", ActionProgressConfig::cookingChurning, ActionIcon.SPRITE_COOKING,26),
	...
	GOLEM_SHAPE("Shaping", ActionProgressConfig::craftGolemShaping, ActionIcon.SPRITE_GOLEM_CRAFTING, 20),
	;
