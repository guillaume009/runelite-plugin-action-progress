...
public class ChatboxDetector extends ActionDetector
{
	...
	private static final Product[] MULTI_MATERIAL_PRODUCTS = {
			...
			new Product(FLETCH_ATTACH_TIPS, DRAGONSTONE_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(DRAGONSTONE_BOLT_TIPS, 10)),
			new Product(FLETCH_ATTACH_TIPS, EMERALD_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(EMERALD_BOLT_TIPS, 10)),
			new Product(FLETCH_ATTACH_TIPS, JADE_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(JADE_BOLT_TIPS, 10)),
			new Product(FLETCH_ATTACH_TIPS, ONYX_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(ONYX_BOLT_TIPS, 10)),
			new Product(FLETCH_ATTACH_TIPS, OPAL_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(OPAL_BOLT_TIPS, 10)),
			new Product(FLETCH_ATTACH_TIPS, PEARL_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(PEARL_BOLT_TIPS, 10)),
			new Product(FLETCH_ATTACH_TIPS, RUBY_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(RUBY_BOLT_TIPS, 10)),
			new Product(FLETCH_ATTACH_TIPS, SAPPHIRE_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(SAPPHIRE_BOLT_TIPS, 10)),
			new Product(FLETCH_ATTACH_TIPS, TOPAZ_DRAGON_BOLTS, new Ingredient(DRAGON_BOLTS, 10), new Ingredient(TOPAZ_BOLT_TIPS, 10)),
